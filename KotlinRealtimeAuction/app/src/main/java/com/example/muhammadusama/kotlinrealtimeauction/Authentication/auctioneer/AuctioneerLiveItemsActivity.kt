...
class AuctioneerLiveItemsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(type.equals("Phone")){
            ...
            mPhoneAdapter = PhoneAdapter(phoneList){
                ...
                val showBiddersIntent = Intent(this,ShowBiddersActivity::class.java)
            ...
            mChildEventListener = object : ChildEventListener {
                ...
                override fun onChildAdded(p0: DataSnapshot, p1: String?) {
                    ...
                    if  (type.equals("Phone")) {
                        ...
                        if (currentDate?.equals(currentPhone?.date)!! &&
                                (currentTime?.compareTo(currentPhone?.startTime!!)!! > 0 &&
                        ...
                        if (currentDate?.equals(currentLaptop?.date)!! &&
                                (currentTime?.compareTo(currentLaptop?.startTime!!)!! > 0 &&
