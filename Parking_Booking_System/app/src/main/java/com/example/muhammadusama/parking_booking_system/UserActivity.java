    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.book_parking_space:
                ...
                Intent areaIntent = new Intent(UserActivity.this, AreasActivity.class);
            ...
            case R.id.cancel_booking:
                ...
                Intent cancelBookingIntent = new Intent(UserActivity.this, CancelBookingActivity.class);
            ...
            case R.id.feedback:
                ...
                Intent feedbackIntent = new Intent(UserActivity.this,UserFeedbackActivity.class);
